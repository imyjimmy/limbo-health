...
//
// Commit-message note:
// Messages are generated by app flows (BinderService / scan pipeline), not typed by users.
// Whatever message arrives here is what gets committed and later enforced by server policy.
...
export class GitEngine {
   ...
   * Message is app-generated contextual metadata, not direct user input.
   */
